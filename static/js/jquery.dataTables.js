	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sZeroRecords": "No se encontro ninguna coincidencia en la busqueda",
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				if ( cOption == '<' )
				{
					...
					if ( cNext == "'" || cNext == '"' )
					{
						...
						{
							sAttr = "fg-toolbar ui-toolbar ui-widget-foot ui-corner-bl ui-corner-br ui-helper-clearfix";
						}
